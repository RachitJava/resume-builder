...
public class SampleDataService {
    ...
    public List<Map<String, Object>> getTemplates() {
        return List.of(
                createTemplate("modern-us", "Modern US", "usa",
                        "Clean, ATS-friendly format popular in USA tech companies", "modern"),
                createTemplate("classic-us", "Classic US", "usa",
                        "Traditional chronological format for corporate USA roles", "classic"),
                createTemplate("minimal-us", "Minimal US", "usa", "Ultra-clean design for creative US positions",
                        "minimal"),
                createTemplate("modern-aus", "Modern Australia", "australia",
                        "Contemporary format following Australian standards", "modern"),
                createTemplate("gov-aus", "Government Australia", "australia",
                        "Detailed format for Australian public sector", "classic"),
                createTemplate("modern-uk", "Modern UK", "uk", "Professional UK format with personal statement",
                        "modern"),
                createTemplate("academic-uk", "Academic UK", "uk", "CV format for UK academic positions", "classic"),
                createTemplate("modern-india", "Modern India", "india", "Contemporary format for Indian IT sector",
                        "modern"),
                createTemplate("detailed-india", "Detailed India", "india", "Comprehensive format with all sections",
                        "classic"),
                createTemplate("euro-minimal", "EU Minimal", "europe", "Europass-inspired minimal format", "minimal"));
    }

    private Map<String, Object> createTemplate(String id, String name, String country, String description,
            String baseStyle) {
    ...
    private ResumeDTO getUsSample() {
        ...
        resume.setSummary(
                "Senior Software Engineer with 8+ years of experience building scalable web applications and leading cross-functional teams. Expertise in React, Node.js, and cloud architecture. Passionate about clean code, mentoring developers, and delivering exceptional user experiences.");
        ...
        resume.setSkills(List.of("JavaScript", "TypeScript", "React", "Node.js", "Python", "AWS", "Docker",
                "Kubernetes", "PostgreSQL", "MongoDB", "GraphQL", "CI/CD"));
        resume.setCertifications(
                List.of("AWS Solutions Architect Professional", "Google Cloud Professional Developer"));
    ...
    private ResumeDTO getAustraliaSample() {
        ...
        resume.setJobTitle("Senior Developer");
        ...
        resume.setSummary(
                "Accomplished IT Professional with 7 years of experience in enterprise software development. Strong background in Agile methodologies and stakeholder management. Australian citizen with full working rights. Demonstrated ability to deliver complex projects on time and within budget.");
        resume.setTemplate("modern");
        ...
        resume.setSkills(List.of("Java", "Kotlin", "Spring Boot", "React", "AWS", "Azure", "PostgreSQL", "Agile/Scrum",
    ...
    private ResumeDTO getUkSample() {
        ...
        resume.setJobTitle("Lead Software Engineer");
        ...
        resume.setSummary(
                "Chartered IT Professional with 6 years of experience in fintech and enterprise solutions. MBCS member with proven track record of delivering secure, scalable applications. Strong communicator adept at translating complex technical concepts for diverse stakeholders.");
        resume.setTemplate("modern");
        ...
        resume.setSkills(List.of("Java", "Kotlin", "Python", "Spring Boot", "Microservices", "AWS", "Kafka",
                "PostgreSQL", "Kubernetes", "TDD/BDD"));
        resume.setCertifications(List.of("MBCS Chartered IT Professional", "AWS Solutions Architect",
    ...
    private ResumeDTO getIndiaSample() {
        ...
        resume.setJobTitle("Technology Lead");
        ...
        resume.setSkills(List.of("Java", "Python", "Spring Boot", "React", "Angular", "AWS", "GCP", "Microservices",
                "Kafka", "MySQL", "MongoDB", "Docker", "Kubernetes"));
        resume.setCertifications(List.of("AWS Certified Solutions Architect", "Google Cloud Professional Data Engineer",
